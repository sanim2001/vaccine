...
if($count>0)
{
echo "<span style='color:red'> Number already exists. Please try with another number or click on this <a href='registered-user-testing.php'>Registered Users</span>";
 echo "<script>$('#submit').prop('disabled',true);</script>";
} else{
	
	echo "<span style='color:green'> It's available for Registration .</span>";
