        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Government Vaccination Information Portal | Already Registeres Users</h1>
...
<form method="post">
  <div class="row">
                       ...
                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="regmobilenumber" name="regmobilenumber" placeholder="Please enter your registered number" required="true">
                                        </div>
<div class="form-group">
...
<h3 align="center" style="color:blue">User number "<?php echo $_POST['regmobilenumber'];?>"</h3>
<hr />
    <?php
...
<?php } } else { ?>
<h4 align="center" style="color:blue;">Not found !</h4>
<?php }}?>
