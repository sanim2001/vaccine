...
<head>
    ...
    <title>Goverment Vaccination Management System | New User Registration</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">New User Registration For Vaccine</h1>
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtissuedid" name="govtissuedid" placeholder="Birth Registration / Voter id / Passport" required="true">
                                        </div>
                                        <div class="form-group">
                                             <label>Enter ID</label>
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder=" Enter Birth Registration / Voter id / Passport"   required="true" onBlur="mobileAvailability()">
                                                <span id="mobile-availability-status" style="font-size:12px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="govtidnumber" name="govtidnumber" placeholder="Enter Mobile Number" required="true">
                                        </div>
