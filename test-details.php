...
<head>
    ...
    <title>Government Vaccination Information Portal | Vaccine Details</title>
...
if($rstatus=='Assigned' || $rstatus=='Vaccine Request' || $rstatus=='1st Dose' || $rstatus=='2nd dose'):?>
...
endwhile;
  ?>
            ...
            <?php elseif($reportstatus=='Vaccine Request'):?>
              <option value="1st Dose">1st Dose</option>
            <option value="2nd dose">2nd dose</option>
            <option value="Delivered">Delivered</option>
            <?php elseif($reportstatus=='1st Dose'):?>
              <option value="2nd dose">2nd dose</option>
            <option value="Delivered">Delivered</option>
             <?php elseif($reportstatus=='2nd dose'):?>
             <option value="Delivered">Delivered</option>
         <?php endif;?>
