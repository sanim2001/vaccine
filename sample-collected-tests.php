...
<head>
    ...
    <title>Government Vaccination Information Portal| 1st Dose Tests</title>
...
<?php include_once('includes/topbar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">1st Dose Tests</h1>
    

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">1st Dose Tests</h6>
                        </div>
                        <div class="card-body">
