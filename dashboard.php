...
<head>
    ...
    <title>Government Vaccination Information Portal | Dashboard</title>
...
$query2=mysqli_query($con,"select id from tbltestrecord where ReportStatus='Vaccine Request'");
$totalontheway=mysqli_num_rows($query2);
//Sample Collected
$query3=mysqli_query($con,"select id from tbltestrecord where ReportStatus='1st Dose'");
$totalsamplecollected=mysqli_num_rows($query3);
//Sent for lab
$query4=mysqli_query($con,"select id from tbltestrecord where ReportStatus='2nd dose'");
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1"> On the way for Vaccine Request
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
