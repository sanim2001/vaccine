...
if ($result) {
echo '<script>alert("Hospital created successfully.")</script>';
...
<head>
    ...
    <title>Government Vaccination Information Portal | Add Hospital</title>
     ...
     <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter Helpline number" pattern="[0-9]{10}" title="10 numeric characters only" required="true" >
