     ...
     <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ontheway-samplecollection-test.php">On the Way for<br />  Vaccine Request</a>
                         <a class="collapse-item" href="sample-collected-test.php">1st Dose Collection</a>
                           <a class="collapse-item" href="samplesent-lab-test.php">2nd Dose Collection</a>
   ...
   <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="add-phlebotomist1.php">Add Notice</a>
                         <a class="collapse-item" href="manage-phlebotomist1.php">Manage</a>
                        </div>
                </div>
            </li>
...
<?php else:    ?>          
 ...
 <li class="nav-item">
                <a class="nav-link" href="patient-search-report.php">
                    <i class="fas fa-fw fa-file"></i>
                    <span>Vaccination Report</span></a>
            </li>
