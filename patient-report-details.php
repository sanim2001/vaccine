...
<head>
    ...
    <title>Goverment Vaccination Management System | User Information</title>
...
<div class="row">
                         <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary" align="center">Vaccination Tracking History</h6>
                                </div>
                                <div class="card-body">
<?php if($num>0){
?>
